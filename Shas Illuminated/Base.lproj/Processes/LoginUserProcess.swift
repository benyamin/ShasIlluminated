...
open class LoginUserProcess: MSBaseProcess
{
    open override func executeWithObj(_ obj:Any?)
    {
        ...
        SIServer().sendRequestMethod(methodName: "login", methodType: POST, parameters: paramters, success: { (responseData) in
